...
func TestProcessOrderUseCase_SaveSuccess(t *testing.T) {
	...
	raw := []byte(`{"order_uid":"o1","track_number":"t1","delivery":{"name":"n","phone":"p"},"payment":{"transaction":"tx","currency":"USD","provider":"p","amount":1},"items":[{"chrt_id":1,"track_number":"t1","price":1,"name":"n","total_price":1,"nm_id":2,"brand":"b"}],"locale":"en","customer_id":"c","delivery_service":"ds","date_created":"2021-11-26T06:22:19Z"}`)
